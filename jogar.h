    ...
    void salvarPontuacao(const char *nomeUsuario, int pontos, const char *nomeArquivo) {
    ...
    void mostraPontuacao(int erros) {
        char nomeUsuario[50];
        ...
        salvarPontuacao(nomeUsuario, pontos, nomeArquivo);
    }
